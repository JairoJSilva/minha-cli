...
func InitialMenuModel() MenuModel {
	return MenuModel{
		Items: []MenuItem{
			...
			{Title: "📡  4. Escanear e Importar Configurações (Scan)", Key: "scan"},
			{Title: "➕  5. Cadastrar Nova Conta / Cliente (Add)", Key: "add"},
			{Title: "✏️   6. Editar Conta / Cliente Existente (Edit)", Key: "edit"},
			{Title: "🗑️   7. Apagar Conta / Cliente (Delete)", Key: "delete"},
			{Title: "📁  8. Mapeamento de Perfis Cadastrados (List)", Key: "list"},
			{Title: "☸️   9. Kubernetes (Status do Cluster)", Key: "k8s"},
			{Title: "🧹  10. Limpar Contexto (Reset de Variáveis)", Key: "clear"},
			{Title: "🚪  11. Sair", Key: "exit"},
		},
		Cursor: 0,
	}
}
